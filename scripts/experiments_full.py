...
data.to_csv("Data/clean_full_lyrics.csv", index=False)
...
data.to_csv('Data/tokenized_lyrics.csv', index=False)
...
lyrical_similarities.to_csv('Data/l_similarities.csv', index=False)
